...
tf.flags.DEFINE_string("train_image_dir", "/data_dir/train_concat_mnist/",
                       "Training image directory.")
tf.flags.DEFINE_string("val_image_dir", "/data_dir/val_concat_mnist/",
                       "Validation image directory.")

tf.flags.DEFINE_string("train_captions_file", "/data_dir/captions_train.json",
                       "Training captions JSON file.")
tf.flags.DEFINE_string("val_captions_file", "/data_dir/captions_val.json",
